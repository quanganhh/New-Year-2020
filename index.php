<!DOCTYPE html>
  <head>
    ...
    <title>Chúc mừng năm mới 2020</title>
	...
	<style>
		...
		.textCD{
			width: 0px;
			height: 0px;
			background: #FFF url('/images/cover.png') top center no-repeat;
  ...
  <body>
	...
	<div class="hi-icon-wrap hi-icon-effect-8">
		...
		<div id="home-button">
			<a href="http://quochung1st.com" class="homepage-btn">Go To Homepage</a>
		</div>
  ...
  <script>
var canvas=document.getElementById("canvastext"),ctx=canvas.getContext("2d"),W=window.innerWidth,H=window.innerHeight,text="2020",text2="Chúc Mừng Năm Mới",skipCount=4,gravity=.2,touched=!1,mouse={},minDist=20,bounceFactor=.6;canvas.height=H;canvas.width=W;function trackPos(a){mouse.x=a.pageX;mouse.y=a.pageY}
...
$(document).ready(function(){
	...
	var listBgMusic = [
		{
			title: "Liên khúc nonstop Chúc Mừng Năm Mới",
	...
	var monkeyCD = ["images/puug.png"];
var textCD = [
		"Mừng xuân Canh Tý chúc mọi người vui vẻ như Chim Sẻ. Khỏe mạnh như Đại Bàng. Giàu sang như chim Phụng. Làm lụng như chim Sâu. Sống lâu như Đà Điểu",
		"Năm hết tết đến – Rước chuột tiễn heo – Ông bà hưởng thọ – Cha mẹ khỏe mạnh – Anh chị thành công – Con cháu học giỏi",
		...
		"Gia đình hạnh phúc, con cháu hiếu thuận, mã đáo thành công.",
	...
	$("#mcd").on('mouseenter', function(){
		...
		$(".textCD").animate({width: "+=700", height: "+=200", left: "+=200"});
	...
	.on('mouseleave', function(){
		...
		$(".mkCD").animate({width: "-=100", height: "-=130"});
		$(".textCD").animate({width: "-=700", height: "-=200", left: 0});
